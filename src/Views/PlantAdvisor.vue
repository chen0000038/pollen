    ...
    <div class="min-h-screen bg-gray-50 personalisation-page">
      ...
      <div class="main-container">
        <div class="section-header">
          <h1>Plant Advisor</h1>
          <p>Hover to plant your favourite plant into the bottom  field and get your personalized planting recommendations.</p>
        </div>
                    ...
                    <div class="plant-header">
                      <div class="name-risk-row">
                        ...
                        <div class="pollen-risk" :class="plant.pollenRiskLevel.toLowerCase()">
                          ...
                          <span class="risk-text">{{ plant.pollenRiskLevel }} Risk</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="overview-container">
            <div class="container mx-auto px-4">
              ...
              <div class="planting-field-container">
                <h3 class="field-title">Planting Field <span class="field-subtitle">- Add plants here</span></h3>
